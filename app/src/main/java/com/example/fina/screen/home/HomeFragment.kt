    ...
    private fun setupSpinners() {
        ...
        viewBinding.spinnerCurrency.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                ...
                Toast.makeText(requireContext(), "Selected Currency: ${selectedCurrency.symbol}", Toast.LENGTH_SHORT).show()
        ...
        viewBinding.spinnerTimePeriod.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                ...
                Toast.makeText(requireContext(), "Selected Time Period: ${selectedTimePeriod.getName(requireContext())}", Toast.LENGTH_SHORT).show()
        ...
        viewBinding.spinnerOrderBy.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                ...
                Toast.makeText(requireContext(), "Selected Order By: ${selectedOrderBy.getName(requireContext())}", Toast.LENGTH_SHORT).show()
